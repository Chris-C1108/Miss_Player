		...
		playHapticSound(type = "tick") {
			...
			try {
				...
				if (type === "tick") {
					...
					osc.frequency.exponentialRampToValueAtTime(420, t + .035);
					gain.gain.setValueAtTime(.07, t);
					gain.gain.exponentialRampToValueAtTime(.001, t + .035);
					osc.connect(gain);
					gain.connect(this.audioCtx.destination);
					osc.start(t);
					osc.stop(t + .04);

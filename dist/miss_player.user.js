...
`;
	...
	var CommentPanel = class CommentPanel {
		...
		initDelegatedEvents() {
			...
			this.uiElements.playerContainer.addEventListener("click", (e) => {
				...
				if (codeLink) {
					...
					if (code) this.handleCodeClick(code);
				} else if (retryBtn) {
					e.stopPropagation();
					this.handleRetry();
				}
		...
		handleCodeClick(code) {
			...
			const { modal, close } = createModal(`<div class="tm-code-action-dialog">
        ...
        </div>`, { extraClass: "tm-code-action-overlay" });
		...
		showCodePreview(code, targetEl) {
            ...
            <div class="jc-code-preview-loading">
                ...
                <span>${__("previewLoading") || "正在加载预览..."}</span>
            </div>
            ...
            <div class="jc-code-preview-fallback" style="display:none;">
                ...
                <span>${__("previewNotFound") || "暂无预览小视频"}</span>
            </div>
        </div>

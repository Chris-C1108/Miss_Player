...
`;
	...
	var PlaybackController = class {
		...
		_playCurrentCapsule() {
			...
			if (mode === "preview") this._currentCapsuleDuration = 5;
			...
			else this._currentCapsuleDuration = 60;

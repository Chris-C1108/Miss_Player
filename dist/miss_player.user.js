...
`;
	...
	var CommentPanel = class CommentPanel {
		...
		reprocessComments() {
			...
			if (this.jableComments && this.jableComments.length > 0) this.jableComments = reprocess(this.jableComments);
			if (this.javlibComments && this.javlibComments.length > 0) this.javlibComments = reprocess(this.javlibComments);
			if (this.javdbComments && this.javdbComments.length > 0) this.javdbComments = reprocess(this.javdbComments);
			this.applyFilter();
			this.renderCommentsList();
		}
		cleanup() {
	...
	var SCRIPT_VERSION = typeof GM_info !== "undefined" && GM_info?.script?.version ? GM_info.script.version : "5.6.25";

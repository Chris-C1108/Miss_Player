	...
	var DebugLogPanel = class {
		...
		static _bindEvents() {
			...
			copyBtn.addEventListener("click", (e) => {
				...
				copyToClipboard(this._logs.map((l) => `[${l.time}] [${l.level.toUpperCase()}] ${l.text}`).join("\n"));
